...
from source_data import source_data, URL_MACHINES, URL_HS, URL_F2POOL, URL_BINANCE, switch_user_id, tz_irk
from bot import send_all_statistics, send_xlsx_statistics

con = sqlite3.connect('example.db')
cur = con.cursor()

sql_insert = '''INSERT INTO hashrate (hs_avg, online_machines, difference, date_, time_) VALUES (?, ?, ?, ?, ?)'''
count_for = 0
